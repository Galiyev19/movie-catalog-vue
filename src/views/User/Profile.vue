...
export default {
    ...
    methods: {
        async getUserData() {
            try {
                const response = await axios.get(`https://server-movie-catalog.onrender.com/auth/me`, {
                    headers: {
        ...
        async upLoadFile(event) {
            try {
                ...
                const response = await axios.post(`https://server-movie-catalog.onrender.com/upload/${userId}`, formData)
                console.log(response.data)
